...
pub trait Governor {
    ...
    /// * `lance_protocol` - The address of the lance-protocol contract
    ...
    /// This allows proposals to be disputed and resolved through the anonymous voting system.
    ///
    ...
    /// ### Panics
    /// * If the proposal_id is invalid
    /// * If the lance-protocol contract address is not set
