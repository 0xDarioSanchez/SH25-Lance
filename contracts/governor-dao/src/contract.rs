...
use crate::{
    // dependencies::VotesClient,  // Commented out - voting logic disabled
...
impl Governor for GovernorContract {
    ...
    fn set_lance_protocol(e: Env, admin: Address, lance_protocol: Address) {
        admin.require_auth();
    ...
    fn propose(
        ...
        // Voting logic commented out - use lance-protocol for disputes instead
        ...
        // votes_client.set_vote_sequence(&vote_start);  // Commented out - voting logic disabled
    ...
    fn close(e: Env, proposal_id: u32) {
        ...
        if e.ledger().sequence() > proposal_data.vote_end + settings.grace_period {
            ...
            // Voting logic commented out - use lance-protocol for dispute resolution
            // let votes_client = VotesClient::new(&e, &storage::get_voter_token_address(&e));
    ...
    fn vote(e: Env, voter: Address, proposal_id: u32, support: u32) {
        ...
        // Voting logic commented out - use lance-protocol for dispute voting
        // let voter_power = VotesClient::new(&e, &storage::get_voter_token_address(&e))
        //     .get_past_votes(&voter, &proposal_data.vote_start);
        // if voter_power <= 0 {
        //     panic_with_error!(&e, GovernorError::InsufficientVotingUnitsError);
        // }
        let voter_power = 1; // Default voter power when voting system is disabled
    ...
    fn create_dispute_for_proposal(
        e: Env,
        creator: Address,
        proposal_id: u32,
        proof: String,
